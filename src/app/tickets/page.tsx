...
export default function TicketsPage() {
  ...
  const createNewTicket = (formData: any) => {
    ...
    sendWhatsAppMessage(newTicket, whatsappMessage);
    setShowModal(false);
  };
  ...
  const updateTicketStatus = (ticketId: number, newStatus: string, note: string = '') => {
    ...
    if (updatedTicket) {
      ...
      if (statusMessage) {
        sendWhatsAppMessage(updatedTicket, statusMessage);
      }
    }
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
              ...
              <button
                onClick={() => sendWhatsAppMessage(selectedTicket, whatsappMessage)}
                style={{
                  padding: '10px 20px',
                  background: '#25D366',
                  color: 'white',
